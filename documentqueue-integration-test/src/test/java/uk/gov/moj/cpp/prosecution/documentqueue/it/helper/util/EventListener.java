...
public class EventListener {
    ...
    public static final String PRIVATE_ACTIVE_MQ_TOPIC = "documentqueue.event";
    public static final String COMMAND_HANDLE_ACTIVE_MQ_QUEUE = "documentqueue.handler.command";
    ...
    public <T> Optional<Envelope<T>> popEvent(final Class<T> eventClass) {
        ...
        return ofNullable(this.eventsByName.get(eventAnnotation.value()).poll())
                .map(jsonEnvelope -> envelopeFrom(jsonEnvelope.metadata(), fromJsonObject(jsonEnvelope.payloadAsJsonObject(), eventClass)));
    }
